...
var styles = function styles(theme) {
  ...
  var palette = theme.palette,
      ...
      spacing = theme.miscellaneous.spacing; // const primaryRgb = palette.primary.rgbShades[500].join(', ');
  ...
  return {
    ...
    overlay: {
      extend: 'absolutePositioned',
      zIndex: 1,
      backgroundImage: "linear-gradient(360deg, rgba(".concat(darkenPrimaryRgb, ", .9) -28.58%, rgba(").concat(darkenPrimaryRgb, ", .1) 93.05%)")
    },

...
var GifsEditFormComponent = function GifsEditFormComponent(_ref) {
  ...
  var hasGiphyKey = (0, _react.useMemo)(function () {
  ...
  var handleGifChange = (0, _react.useCallback)(function (url) {
    interestChanged(selectedIndex, 'gifUrl', url);
  }, [interestChanged, selectedIndex]);
  return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, hasGiphyKey && /*#__PURE__*/_react.default.createElement(_search_gifs_dialog.SearchGifsDialog, {
    open: Boolean(selectedIndex !== null),
    onClose: removeSelectedIndex,
    onSelect: handleGifSelection
  }), !hasGiphyKey && /*#__PURE__*/_react.default.createElement(_url_fallback_dialog.URLFallbackDialog, {
    open: Boolean(selectedIndex !== null),
    onClose: removeSelectedIndex,

...
var mode = process.env.REACT_APP_MODE || 'readOnly';
...
function App() {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            blob = new Blob([JSON.stringify(_objectSpread({}, data, {
              resumeCustomization: customization
            }))], {
              type: 'text/plain; charset=utf-8'
            });
            (0, _downloadjs.default)(blob, "".concat("Resume-".concat((data === null || data === void 0 ? void 0 : (_data$basics = data.basics) === null || _data$basics === void 0 ? void 0 : _data$basics.name) || 'Developer').replace(' ', '-'), ".json"), 'text/plain; charset=utf-8');
  ...
  return /*#__PURE__*/_react.default.createElement(_package.default, {
    ...
    additionalNodes: {
      banner: {
        actionsButtons: mode === 'edit' && /*#__PURE__*/_react.default.createElement(_ui.Button, {
          variant: "outlined",
          onClick: handleClick,
          color: 'light'
